...
import 'package:employee_management/Screens/Loacation/direction_repository.dart';
...
class MapSampleState extends State<MapSample> {
  ...
  static final CameraPosition _intitialCameraPosition = CameraPosition(
    target: LatLng(34.739822, 10.760020),
    zoom: 14.4746,
  );
          ...
          if (_info != null)
            Positioned(
              ...
              child: Container(
                ...
                child: Text(
                  '${_info!.totaleDistance},${_info!.totaleDuration}',
